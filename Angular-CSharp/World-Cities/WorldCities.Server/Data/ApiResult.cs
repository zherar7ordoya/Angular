...
// Orden recomendado dentro de una clase C#:
// 1. Constantes y campos privados (private, readonly)
// 2. Propiedades públicas o internas (public, internal)
// 3. Constructores
// 4. Métodos públicos
// 5. Métodos privados o auxiliares
// 6. Eventos o delegados (si aplica)
// 7. Métodos estáticos (si aplica)
...
public class ApiResult<T>
{
    ...
    /// <summary>Filter Query string (to be used within the given FilterColumn).</summary>
    ...
    /// <summary>Private constructor called by the CreateAsync method.</summary>
                                                       ...
                                                       string? filterQuery = null)
    {
        ...
        if (!string.IsNullOrEmpty(sortColumn) && IsValidProperty(sortColumn))
        {
            sortOrder =
                ...
                && sortOrder.Equals("ASC", StringComparison.CurrentCultureIgnoreCase) ? "ASC" : "DESC";
    ...
    /// <summary>Checks if the given property name exists to protect against SQL injection attacks.</summary>
